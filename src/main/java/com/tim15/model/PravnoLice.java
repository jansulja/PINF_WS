...
public PravnoLice(String telefon, String email, String adresa, String password) {
	super(telefon, email, adresa, password);
	// TODO Auto-generated constructor stub
}
public PravnoLice(String telefon, String email, String adresa, String password, String naziv, double maticniBroj,
		double pib, String sifraPretezneDelatnosti, String klasifikacija) {
	super(telefon, email, adresa, password);
	this.naziv = naziv;
...
public String toString() {
	return "PravnoLice [naziv=" + naziv + ", maticniBroj=" + maticniBroj + ", pib=" + pib + ", sifraPretezneDelatnosti="
			+ sifraPretezneDelatnosti + ", klasifikacija=" + klasifikacija + ", toString()=" + super.toString() + "]";
}
