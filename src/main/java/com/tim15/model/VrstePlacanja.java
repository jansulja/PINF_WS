...
public class VrstePlacanja {
   public double oznakaVrste;
   public java.lang.String nazivVrstePlacanja;
   
   /** @pdRoleInfo migr=no name=AnalitikaIzvoda assc=vrstaPlacanja coll=java.util.Collection impl=java.util.HashSet mult=0..* */
